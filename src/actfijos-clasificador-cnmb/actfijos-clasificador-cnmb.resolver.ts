...
export class ActfijosClasificadorCnmbResolver {
  ...
  async saveActFijosClasificadorCnmb(@Args('actfijosClasificadorCnmbInput') actfijosClasificadorCnmbInput: ActFijosClasificadorCnmbInput): Promise<ActFijosClasificadorCnmbEntity> {
