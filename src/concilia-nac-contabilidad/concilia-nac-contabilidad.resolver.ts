...
export class ConciliaNacContabilidadResolver {
  constructor(private _conciliacionContabService: ConciliaNacContabilidadService) {}
  ...
  @Mutation(() => MutationResponse)
  async updateConciliaContab(@Args({ name: 'data', type: () => [ConciliaNacContabilidadInput] }) data: ConciliaNacContabilidadInput[]): Promise<MutationResponse> {
