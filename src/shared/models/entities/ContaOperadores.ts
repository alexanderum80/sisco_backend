...
export class ContaOperadores {
  ...
  @OneToMany(() => ContaComprobarExpresiones, contaComprobarExpresiones => contaComprobarExpresiones.idOperador)
  contaComprobarExpresiones: ContaComprobarExpresiones[];

  @OneToMany(() => ContaComprobarValores, contaComprobarValores => contaComprobarValores.idOperador)
