...
export class ContaExpresionesDetalle {
  ...
  @ManyToOne(() => ContaExpresionesResumen, contaExpresionesResumen => contaExpresionesResumen.contaExpresionesDetalles, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
  @JoinColumn([{ name: 'IdExpresion', referencedColumnName: 'idExpresion' }])
  idExpresion: ContaExpresionesResumen;

  @ManyToOne(() => ContaTipoValorExpresiones, contaTipoValorExpresiones => contaTipoValorExpresiones.contaExpresionesDetalles, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
