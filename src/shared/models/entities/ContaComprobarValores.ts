...
export class ContaComprobarValores {
  ...
  @ManyToOne(() => ContaExpresionesResumen, contaExpresionesResumen => contaExpresionesResumen.contaComprobarValores, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
  @JoinColumn([{ name: 'IdExpresion', referencedColumnName: 'idExpresion' }])
  idExpresion2: ContaExpresionesResumen;

  @ManyToOne(() => ContaOperadores, contaOperadores => contaOperadores.contaComprobarValores)
