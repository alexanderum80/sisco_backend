...
export class CajaOperaciones {
  ...
  @ManyToOne(() => CajaTipoOperacion, cajaTipoOperacion => cajaTipoOperacion.cajaOperaciones, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
  @JoinColumn([{ name: 'IdOperacion', referencedColumnName: 'idOperacion' }])
  idOperacion2: CajaTipoOperacion;

  @ManyToOne(() => CajaTipoCajas, cajaTipoCajas => cajaTipoCajas.cajaOperaciones, { onDelete: 'CASCADE', onUpdate: 'CASCADE' })
