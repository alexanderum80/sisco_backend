...
export class ContaExpresionesResumen {
  ...
  @OneToMany(() => ContaComprobarExpresiones, contaComprobarExpresiones => contaComprobarExpresiones.idExpresion)
  contaComprobarExpresiones: ContaComprobarExpresiones[];

  @OneToMany(() => ContaComprobarExpresiones, contaComprobarExpresiones => contaComprobarExpresiones.idExpresionC)
  contaComprobarExpresiones2: ContaComprobarExpresiones[];

  @OneToMany(() => ContaComprobarValores, contaComprobarValores => contaComprobarValores.idExpresion2)
  contaComprobarValores: ContaComprobarValores[];

  @OneToMany(() => ContaExpresionesDetalle, contaExpresionesDetalle => contaExpresionesDetalle.idExpresion)
